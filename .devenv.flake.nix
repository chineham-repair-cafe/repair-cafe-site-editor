{
  inputs =
    let
      version = "1.0.7";
system = "x86_64-linux";
devenv_root = "/home/dominic.rodriguez/projects/git.shymega.org.uk/chineham-repair-cafe/repair-cafe-site-editor";
devenv_dotfile = ./.devenv;
devenv_dotfile_string = ".devenv";
container_name = null;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-bbf2a42";
